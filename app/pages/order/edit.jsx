...
export default function EditOrder() {
    ...
    const orderDetails = JSON.parse(order.details).map((detail) => ({
    ...
    return (
        ...
        >
            ...
            <Button action={() => handleValidation()}>Perbarui Order</Button>
            ...
            <View style={styles.container}>
                <Dialog.Container visible={visible}>
                    ...
                    <Dialog.Description>Perbarui data order ini?</Dialog.Description>
